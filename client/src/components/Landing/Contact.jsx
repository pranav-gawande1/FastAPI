    ...
    return (
        ...
        <section id="ContactUS" className="scroll-mt-16">
            <div className='max-w-[1200px] mx-auto my-0 py-12 px-4 sm:px-6 lg:px-8'>
                <h2 className="mb-4 text-center text-xl sm:text-2xl lg:text-3xl font-bold text-[#1D3557]"> Contact Us</h2>
                <form className='max-w-[600px] my-0 mx-auto flex flex-col gap-8 sm:gap-6 lg:gap-4'>
